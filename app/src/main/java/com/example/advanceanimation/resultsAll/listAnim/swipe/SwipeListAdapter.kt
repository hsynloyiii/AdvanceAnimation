...
class SwipeListAdapter : ListAdapter<Rocket, SwipeListAdapter.ViewHolder>(Rocket.DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(
        ...
        itemView.setOnClickListener {
            Toast.makeText(
                it.context,
                "${getItem(bindingAdapterPosition).name} clicked. Swipe to left to delete",
                Toast.LENGTH_SHORT
            ).show()
        }
    }
